#!/usr/bin/env sh
# Universal installer for iocrep. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/iocrep.git"
echo "Installing iocrep ..."
