"""IOCREP core — Score IOCs against offline reputation/allow lists with explainable verdicts."""
...
RULES = [
    ("IOC-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("IOC-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("IOC-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
