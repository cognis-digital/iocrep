...
import argparse, sys
from iocrep.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="iocrep", description="IOCREP — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from iocrep.mcp_server import serve
        return serve()
    if args.cmd == "scan":
